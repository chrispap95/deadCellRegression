...
void TMVARegression_layerSum( TString myMethodList = "" )
{
   /*
   ...
   */
   ...
   TString uniqueid = "TMVAReg_flat_cmssw_full_Feb2020_E0to3000";
   ...
   */
   ...
   dataloader->PrepareTrainingAndTestTree(mycut,
                                         "nTrain_Regression=200000:nTest_Regression=80000:SplitMode=Random:NormMode=NumEvents:!V" );
   //
   //     dataloader->PrepareTrainingAndTestTree( mycut,
   ...
   */
   ...
   if (Use["DNN_CPU"]) {
      TString layoutString("Layout=SYMMRELU|22,Layout=SYMMRELU|5,Layout=SYMMRELU|5,"
                           "LINEAR");
