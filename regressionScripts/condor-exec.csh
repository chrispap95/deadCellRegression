...
set nodes=$1 # number of nodes per layer
set train=$2 # number of cells used for training
set test=$3 # number of cells used for testing
set energyRange=0to3000
set sampleSize=12M  # How large is the sample you are using in terms of dead cells number
set UNIQUEID=cmsswTrain_full_E${energyRange}_4cores_${sampleSize}_${nodes}nodes_3hl_excludeDead
