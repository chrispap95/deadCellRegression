...
void TMVARegression_new( TString myMethodList = "" )
{
   ...
   */
   dataloader->AddVariable( "MLlayer", "layer", "units", 'F' );
   dataloader->AddVariable( "MLn1", "neighbor 1", "units", 'F' );
   dataloader->AddVariable( "MLn2", "neighbor 2", "units", 'F' );
   dataloader->AddVariable( "MLn3", "neighbor 3", "units", 'F' );
   dataloader->AddVariable( "MLn4", "neighbor 4", "units", 'F' );
   dataloader->AddVariable( "MLn5", "neighbor 5", "units", 'F' );
   dataloader->AddVariable( "MLn6", "neighbor 6", "units", 'F' );
   dataloader->AddVariable( "MLnup", "neighbor up", "units", 'F' );
   dataloader->AddVariable( "MLndown", "neighbor down", "units", 'F' );
   dataloader->AddVariable( "MLun1", "up 1", "units", 'F' );
   dataloader->AddVariable( "MLun2", "up 2", "units", 'F' );
   dataloader->AddVariable( "MLun3", "up 3", "units", 'F' );
   dataloader->AddVariable( "MLun4", "up 4", "units", 'F' );
   dataloader->AddVariable( "MLun5", "up 5", "units", 'F' );
   dataloader->AddVariable( "MLun6", "up 6", "units", 'F' );
   dataloader->AddVariable( "MLdn1", "down 1", "units", 'F' );
   dataloader->AddVariable( "MLdn2", "down 2", "units", 'F' );
   dataloader->AddVariable( "MLdn3", "down 3", "units", 'F' );
   dataloader->AddVariable( "MLdn4", "down 4", "units", 'F' );
   dataloader->AddVariable( "MLdn5", "down 5", "units", 'F' );
   dataloader->AddVariable( "MLdn6", "down 6", "units", 'F' );
