{
    ...
    gr2->SetTitle("deadfrac = 5% + average");
    //gr3->SetTitle("deadfrac = 5% + LS average");
    gr4->SetTitle("deadfrac = 5% + ML regression");
    ...
    lg->AddEntry(gr2,"deadfrac = 5% + average","lp");
    //lg->AddEntry(gr3,"deadfrac = 5% + LS average","lp");
    lg->AddEntry(gr4,"deadfrac = 5% + ML regression","lp");
    lg->Draw();
    gPad->Update();
